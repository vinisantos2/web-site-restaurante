...
import CardapioForm from "@/src/componentsAdm/CardapioForm"
import EditCardModal from "@/src/components/EditCardModal"
import CardViewAdm from "@/src/componentsAdm/CardViewAdm"
...
export default function HomeAdmin() {
  ...
  async function handleAddCard() {
    const { title, description, imageUrl } = newCard
    ...
    try {
      ...
      setNewCard({ title: "", description: "", imageUrl: "", valor: 0 })
    } catch (error) {
