...
export function AboutSection() {
    return (
        <section
            id="sobre"
            className="py-20 px-4 bg-gradient-to-r from-white to-yellow-100 transition-opacity duration-1000"
        >
            <div className="max-w-5xl mx-auto">
                <Title title="Sobre Nós" subtitle="Conheça nossa história e paixão pela gastronomia" center />
